...
net stop %SRVCNAME%
sc delete %SRVCNAME%
sc create %SRVCNAME% binPath= "\"%~dp0winws.exe\" %ARGS%" DisplayName= "AntiZapret Service V4 (General list): %SRVCNAME%" start= auto
sc description %SRVCNAME% "AntiZapret Service V4 (General list)"
sc start %SRVCNAME%
pause
