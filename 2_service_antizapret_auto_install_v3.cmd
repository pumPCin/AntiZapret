...
net stop %SRVCNAME%
sc delete %SRVCNAME%
sc create %SRVCNAME% binPath= "\"%~dp0winws.exe\" %ARGS%" DisplayName= "AntiZapret Service V3 (Auto): %SRVCNAME%" start= auto
sc description %SRVCNAME% "AntiZapret Service V3 (Auto)"
sc start %SRVCNAME%
pause
